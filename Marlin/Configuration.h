...
// BTT SFS V1.0 - Smart Filament Sensor
 ...
 */
  ...
  */
  #define NOZZLE_TO_PROBE_OFFSET {-36.38, -0, -1.735} 
#endif
 ...
 */
 ...
 //Creality SKR E3 Mini V3 Board Settings
  ...
  #else
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 79.6, 400, 97.09 }
  #endif
 ...
 #define DEFAULT_Kd 71.17
  ...
  #define DEFAULT_bedKp 104.72
  #define DEFAULT_bedKi 19.25
  #define DEFAULT_bedKd 379.79
